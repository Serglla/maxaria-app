...
fs.copyFileSync(path.join(KIT, "login-erp.js"), P("public", "js", "login-erp.js"));
...
// 6b) CSP: permitir Google Fonts (la fuente Inter del tema), solo en la demo
const srv3 = srv2
  .replace('styleSrc: ["\'self\'", "\'unsafe-inline\'"],', 'styleSrc: ["\'self\'", "\'unsafe-inline\'", "https://fonts.googleapis.com"],')
  .replace('fontSrc: ["\'self\'", "data:"],', 'fontSrc: ["\'self\'", "data:", "https://fonts.gstatic.com"],');
if (srv3 !== srv) { write(srvPath, srv3); changed++; }
